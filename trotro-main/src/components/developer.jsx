...
const teamMembers = [
  {
    ...
    story:
      "The architect of Trofficient's core systems. Spent 72 consecutive hours debugging our routing algorithm during launch week. Believes 'sleep is for the optimized' when closing in on a solution.",
